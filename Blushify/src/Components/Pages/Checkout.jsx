        ...
        <div className="row g-4 mt-5">
            <div className="col-lg-7">
                ...
                <div className="container my-5">
                    ...
                    <p className="text-muted mb-3">All transaction are secure and encrypted.</p>
                        ...
                        <div className="p-3 bg-light">
                            ...
                            <div className="form-check mb-3">
                                ...
                                <label className="form-check-label" htmlFor="billingCheck">
                                    Use shipping addres as billing address
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-5">
                    <div className="card border-0 shadow-sm rounded-4 p-4">
                        ...
                        {cartItems.length === 0 ? (
                            ...
                            cartItems.map(item => (
                                <div key={item.id} className="d-flex align-items-center mb-3 border-bottom pb-2">
                                    <img src={item.image} className='rounded' width='60' height='60'style={{objectFir:'cover', marginRight:'10px'}} alt="" />
                        ...
                        <i className="ri-arrow-left-line me-1"></i> Back To Cart!</Link>
                    </div>
                </div>
            </div>
        </div>
