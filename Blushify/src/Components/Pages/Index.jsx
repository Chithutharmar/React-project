...
import subBanner1 from './../../assets/images/banner-1.webp'
import subBanner2 from './../../assets/images/banner-2.webp'

import serviceImg1 from './../../assets/images/service-icon-1.svg'
import serviceImg2 from './../../assets/images/service-icon-2.svg'
import serviceImg3 from './../../assets/images/service-icon-3.svg'
import serviceImg4 from './../../assets/images/service-icon-4.svg'

import brand1 from './../../assets/images/brand-1.png'
import brand2 from './../../assets/images/brand-2.png'
import brand3 from './../../assets/images/brand-3.png'

import femalebanner from './../../assets/images/banner-female.webp'

import discover1 from './../../assets/images/discover-1.webp'
import discover2 from './../../assets/images/discover-2.webp'

import socialImage1 from './../../assets/images/social-image-1.jpg'
import socialImage2 from './../../assets/images/social-image-2.jpg'
import socialImage3 from './../../assets/images/social-image-3.jpg'
import socialImage4 from './../../assets/images/social-image-4.jpg'
import socialImage5 from './../../assets/images/social-image-5.jpg'
  ...
  return (
    <>
       ...
       <div className="product-container py-5 my-5">
        <div className="container positi-relative">
          <div className="row">
        ...
        <div className="container">
          ...
          <div className="row pt-3 justify-content-center">
            <div className="col-md-4 mb-4 seen-card">
              ...
              <p className="text-dark fs-5 mt-2 fw-semibold">p-1 "Also the customer serrvice is phenomenal.  I would purchase again."</p>
            </div>
            <div className="col-md-4 mb-4 seen-card">
       ...
       <div className='discover container py-5'>
        <div className='section-title mb-5 favorite-beauty-title text-center'>
          ...
          <p className="text-center">Our bundles were designed to conveniently package <br /> Your
        ...
        <div className='row g-5'>
          <div className='col-md-6 discover-card text-center'>
            ...
            <div className='discover-info mt-3'>
              ...
              <button className='btn mt-2'>Shop Now <i className='bi bi-arrow-right ms-2'></i>
              </button>
            </div>
          </div>
          <div className='col-md-6 discover-card text-center'>
            ...
            <div className='discover-info mt-3'>
              <div>Summer Collection</div>
              <button className='btn mt-2'>Read More<i className='bi bi-arrow-right ms-2'></i>
              </button>
            </div>
          </div>
        </div>
