...
import payment3 from './../../assets/images/payment-3.svg'
import payment4 from './../../assets/images/payment-4.svg'
import payment5 from './../../assets/images/payment-5.svg'
import payment6 from './../../assets/images/payment-6.svg'
            ...
            <div className="col-lg-4">
              <div className="footer-logo text-center">
                <a href="#" className="navbar-brand mx-auto order-0">
                  <h2 className="m-0 fw-bold" style={{ letterSpaceing: '2px'}}>BLUSHIFY</h2>
                </a>
              </div>
            </div>
            <div className='col-lg-4'>
