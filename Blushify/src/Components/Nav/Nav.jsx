...
function Nav() {
    ...
    useEffect(() => {
        ...
        const handleCartUpdate = () => updatedCounts();
        const handleWishlistUpdate = () => updatedCounts();
            ...
            <ul className="d-lg-none d-flex align-items-center gap-3">
                ...
                <li className="nav-item position-relative">
                    <Link to='/wishlist'>
                        ...
                        <span className="position-absolute top-0 start-100 translate-middle cart-qount rounded-pill">{wishlistCount ||0}</span>
                    </Link>
                </li>
                <li className="nav-item position-relative">
                    <Link to='/cart'>
                        <i className="bi bi-bag fs-5 text-dark"></i>
                        <span className="position-absolute top-0 start-100 translate-middle cart-qount rounded-pill">{cartCount || 0}</span>
                    </Link>
                </li>
            </ul>
          ...
          <div className="modal-body">
            <form>
                ...
                <p className="text-muted">
                    By signing up, you agree to out <a href="#" className='text-success text-decoration-none'>Terms</a> & <a href="#" className='text-success text-decoration-none'>Privacy Policy</a>
                </p>
