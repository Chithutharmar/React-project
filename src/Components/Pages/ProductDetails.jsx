        ...
        <div className="container my-5">
            ...
            <div className="tab-content" id='productTabContent'>
                ...
                <div className="tab-pane fade" id="shipping" role="tabpanel">
                    <p>
                        We typically process and ship orders within 1-2 business days after payment confirmation. Shipping charges are calculated at checkout based on your
                        location and the selected shipping method. Free shipping may be available 
                        on orders over $50, depending on current promotions. Once your order has been 
                        shipped, you will receive a confirmation email with a tracking number to monitor your package's 
                        delivery status. Standard shipping usually takes 5-7 business days, excluding weekends and public 
                        holidays. Please note that delivery times may vary during peak seasons, promotional periods, or 
                        due to unforeseen circumstances such as weather conditions or courier delays. Customers are responsible 
                        for providing accurate shipping details at checkout, as we are not liable for delays caused by incorrect or 
                        incomplete address information. If you have any questions regarding your order or shipment, our customer support 
